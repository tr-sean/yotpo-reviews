<?php
    ...
    class Yotpo_Reviews_Public {
        ...
        public function override_reviews_template( $template ) {
            ...
            // return method_exists($woocommerce, 'comments_template_loader') ? $woocommerce->comments_template_loader($template) : false;
        ...
        public function post_yotpo_review() {
    	    ...
    	    wp_redirect( $_POST['product_url'] . '?review=' . $result );
    	}
